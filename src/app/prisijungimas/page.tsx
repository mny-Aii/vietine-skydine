...
export default function SigninPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    console.log('Forma pateikta', { email, password, keepLoggedIn })
  }
            ...
            <div>
              <div className="mb-5 sm:mb-8">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Iveskite savo el. pasto adresa ir slaptazodi prisijungimui!
                </p>
              </div>
              <div>
                ...
                <form onSubmit={handleSubmit}>
                  <div className="space-y-5">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <label htmlFor="keepLoggedIn" className="flex items-center text-sm font-normal text-gray-700 cursor-pointer select-none dark:text-gray-400">
                          <div className="relative">
                            <input
                            ...
                            <div
                              className={`mr-3 flex h-5 w-5 items-center justify-center rounded-md border-[1.25px] ${
                                keepLoggedIn ? 'border-brand-500 bg-brand-500' : 'bg-transparent border-gray-300 dark:border-gray-700'
                              }`}
                            >
                              {keepLoggedIn && (
                ...
                <div className="mt-5">
                  <p className="text-sm font-normal text-center text-gray-700 dark:text-gray-400 sm:text-start">
                    Neturite paskyros?{' '}
                    <Link href="/registracija" className="text-brand-500 hover:text-brand-600 dark:text-brand-400">
                      Registruotis
                    </Link>
                  </p>
                </div>
