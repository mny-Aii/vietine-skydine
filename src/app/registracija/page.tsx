...
export default function SignupPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    console.log('Forma pateikta', { firstName, lastName, email, password, agreeTerms })
  }
            ...
            <div>
              <div className="mb-5 sm:mb-8">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Iveskite savo duomenis noredami sukurti paskyra!
                </p>
              </div>
              <div>
                ...
                <div className="relative py-3 sm:py-5">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="p-2 text-gray-400 bg-white dark:bg-gray-900 sm:px-5 sm:py-2">Arba</span>
                  </div>
                </div>
                  ...
                  <div className="space-y-5">
                    <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                      <div>
                        <label htmlFor="firstName" className="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                          Vardas<span className="text-error-500">*</span>
                        </label>
                        <input
                          value={firstName}
                      ...
                      <div>
                        <label htmlFor="lastName" className="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                          Pavarde<span className="text-error-500">*</span>
                        </label>
                        <input
                          value={lastName}
                    ...
                    <div>
                      <label htmlFor="email" className="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                        El. pastas<span className="text-error-500">*</span>
                      </label>
                      <input
                        value={email}
                    ...
                    <div>
                      <label htmlFor="password" className="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                        Slaptazodis<span className="text-error-500">*</span>
                      </label>
                      <div className="relative">
                        <input
                          ...
                          id="password"
                          placeholder="Sukurkite slaptazodi"
                        ...
                        >
                          <svg className="fill-current" width="20" height="20" viewBox="0 0 20 20">
                            <path fillRule="evenodd" clipRule="evenodd" d="M10.0002 13.8619C7.23361 13.8619 4.86803 12.1372 3.92328 9.70241C4.86804 7.26761 7.23361 5.54297 10.0002 5.54297C12.7667 5.54297 15.1323 7.26762 16.0771 9.70243C15.1323 12.1372 12.7667 13.8619 10.0002 13.8619Z" fill="#98A2B3"/>
                          </svg>
                        </button>
                      </div>
                    </div>
                    <div>
                      <label htmlFor="agreeTerms" className="flex items-start text-sm font-normal text-gray-700 cursor-pointer select-none dark:text-gray-400">
                        <div className="relative mt-0.5">
                          ...
                          <div
                            className={`mr-3 flex h-5 w-5 items-center justify-center rounded-md border-[1.25px] ${
                              agreeTerms ? 'border-brand-500 bg-brand-500' : 'bg-transparent border-gray-300 dark:border-gray-700'
                            }`}
                          >
                            {agreeTerms && (
                ...
                <div className="mt-5">
                  <p className="text-sm font-normal text-center text-gray-700 dark:text-gray-400 sm:text-start">
                    Jau turite paskyra?{' '}
                    <Link href="/prisijungimas" className="text-brand-500 hover:text-brand-600 dark:text-brand-400">
                      Prisijungti
                    </Link>
                  </p>
                </div>
